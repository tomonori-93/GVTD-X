...
!-- A retrieval program for a 2-dim analytical vortex in Lee et al. (2006 TAO)
!-- [Caution] : The stream functions defined in Eqs. (1)-(2) of Lee et al.
!--             are discontinue at R_ell. 
...
!-- namelist
  integer :: nxd, nyd, nr_d, nr_t, nt_d, nt_t
  integer :: nrot, ndiv
  ...
  double precision :: rvmax, zmax, epsr, vpa
...
!-- internal
  ...
  namelist /input /undef, rvmax, zmax, epsr, vpa,  &
  &                us, vs, nrot, ndiv
...
!-- producing vortex profiles at vector points
  call prod_vortex_structure_L06( rh_t, t_ref_t, rvmax, zmax, epsr,  &
  &                               vpa*d2r, Vt_rht_t, Ut_rht_t )
