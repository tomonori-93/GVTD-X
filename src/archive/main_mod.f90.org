...
!$omp do schedule(runtime) private(kk,ii,jj)
  ...
  &                             -(phic_nr(kk,ii)+phic_nr(kk,ii-1))*sinen(kk,jj))
              VRT_nrt(kk,ii,jj)=VRT_nrt(kk,ii,jj)*knmax_inv
              VRR_nrt(kk,ii,jj)=VRR_nrt(kk,ii,jj)*knmax_inv
           end do
        end do
     end do
!$omp end do
...
!$omp do schedule(runtime) private(kk,jj)
  ...
  &                         -(phic_nr(kk,1))*sinen(kk,jj))
           VRT_nrt(kk,1,jj)=VRT_nrt(kk,1,jj)*knmax_inv
           VRR_nrt(kk,1,jj)=VRR_nrt(kk,1,jj)*knmax_inv
        end do
     end do
!$omp end do
!$omp end parallel
...
!$omp do schedule(runtime) private(kk,ii,jj)
  ...
  &                                *sinen(kk,jj))
              ...
              VDR_mrt(kk,ii,jj)=-(line_integral( nnr-1, rdh(1:nnr), dgkrr(kk,1:nnr,ii), Ds_mr(kk,1:nnr) )  &
  &                               *sinen(kk,jj)  &
